 ...
 */
export const workerEventPayloadSchema = z
  .object({
...
export type WorkerEventPayload = z.infer<typeof workerEventPayloadSchema>;

/**
 * Response schema for the ingest endpoint
 */
export const workerEventResponseSchema = z
  .object({
    success: z.boolean(),
    event_id: z.string(),
...
export type WorkerEventResponse = z.infer<typeof workerEventResponseSchema>;
