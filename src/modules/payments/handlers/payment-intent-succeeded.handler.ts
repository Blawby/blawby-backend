...
import { handlePracticeCustomerIntakeSucceeded } from '@/modules/practice-customer-intakes/handlers/succeeded.handler';
...
export const handlePaymentIntentSucceeded
  = async function handlePaymentIntentSucceeded(
    ...
    try {
      ...
      // 6. Check if this is a practice customer intake and handle it
      await handlePracticeCustomerIntakeSucceeded(paymentIntentData as Stripe.PaymentIntent);
