...
ALTER TABLE "engagement_contracts" ADD COLUMN "intake_id" uuid;--> statement-breakpoint
DELETE FROM "engagement_contracts" WHERE "intake_id" IS NULL;--> statement-breakpoint
ALTER TABLE "engagement_contracts" ALTER COLUMN "intake_id" SET NOT NULL;--> statement-breakpoint
