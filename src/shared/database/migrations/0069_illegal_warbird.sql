...
ALTER TABLE "client_intake_profiles" ADD CONSTRAINT "client_intake_profiles_discount_check" CHECK ((("client_intake_profiles"."amount_off" is null and "client_intake_profiles"."percent_off" is null and "client_intake_profiles"."currency" is null) or ("client_intake_profiles"."amount_off" > $1 and "client_intake_profiles"."currency" is not null and "client_intake_profiles"."percent_off" is null) or ("client_intake_profiles"."percent_off" > $2 and "client_intake_profiles"."percent_off" <= $3 and "client_intake_profiles"."amount_off" is null and "client_intake_profiles"."currency" is null)));