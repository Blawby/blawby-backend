...
ALTER TABLE "practice_member_profiles" ADD CONSTRAINT "practice_member_profiles_member_id_members_id_fk" FOREIGN KEY ("member_id") REFERENCES "public"."members"("id") ON DELETE cascade ON UPDATE no action;