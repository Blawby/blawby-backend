...
ALTER TABLE "krabiclaw_connect_operations" ADD CONSTRAINT "krabiclaw_connect_operations_connected_account_id_stripe_connected_accounts_id_fk" FOREIGN KEY ("connected_account_id") REFERENCES "public"."stripe_connected_accounts"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
