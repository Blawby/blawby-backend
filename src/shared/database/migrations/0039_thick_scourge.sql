...
ALTER TABLE "identity_upgrade_claims" ALTER COLUMN "anon_user_id" SET DATA TYPE uuid USING "anon_user_id"::uuid;--> statement-breakpoint
ALTER TABLE "identity_upgrade_claims" ALTER COLUMN "anon_user_id" DROP NOT NULL;--> statement-breakpoint
ALTER TABLE "identity_upgrade_claims" ALTER COLUMN "registered_user_id" SET DATA TYPE uuid USING "registered_user_id"::uuid;--> statement-breakpoint
