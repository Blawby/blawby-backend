CREATE TABLE "pending_actions" (
	...
	CONSTRAINT "pending_actions_status_check" CHECK (status IN ('pending', 'approved', 'rejected', 'executing', 'executed', 'failed', 'expired'))
);
...
CREATE INDEX "idx_pending_actions_idempotency_key" ON "pending_actions" USING btree ("idempotency_key");
