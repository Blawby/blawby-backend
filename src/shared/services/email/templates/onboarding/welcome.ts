    ...
    ${cardSection(`
      <mj-column>
        ...
        <mj-text color="${COLORS.text}" font-size="16px" font-weight="500" padding-top="10px">
          Once your account is connected you will be able to <a href="${data.tutorialUrl}" style="color: #000000;">add a client</a> and send invoices. You might find our tutorial on <a href="${data.tutorialUrl}" style="color: #000000;">account basics</a> useful.
        </mj-text>
        <mj-text color="${COLORS.text}" font-size="16px" font-weight="500" padding-top="10px">
